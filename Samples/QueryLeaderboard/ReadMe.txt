...
Summary: This app uses the ATLAS Query system to make a simple leaderboard query, retrieving the top 5 players sorted by win-loss ratio. The query was created via the ATLAS admin site within the Ruleset described in the following wiki article:
