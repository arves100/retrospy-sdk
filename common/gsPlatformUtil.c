...
#if defined(_X360)
	//#include "../common_x360/gsUtilX360.c"
#elif defined(_XBOX)
	//#include "../common_xbox/gsUtilXBox.c"
#elif defined(_WIN32)
	#include "../common_win32/gsUtilWin32.c"
#elif defined(_LINUX)
	#include "../common_linux/gsUtilLinux.c"
#elif defined(_MACOSX)
	#include "../common_macosx/gsUtilMacOSX.c"
#elif defined(_NITRO)
	#include "../common_nitro/gsUtilNitro.c"
#elif defined(_PS2)
	#include "../common_ps2/gsUtilPs2.c"
#elif defined(_PS3)
	#include "../common_ps3/gsUtilPs3.c"
#elif defined(_PSP)
	#include "../common_psp/gsUtilPSP.c"
#elif defined(_REVOLUTION)
	#include "../common_revolution/gsUtilRevolution.c"
#else
