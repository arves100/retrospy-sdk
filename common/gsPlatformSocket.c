...
#if defined(_X360)
	#include "../common_x360/gsSocketX360.c"
#elif defined(_XBOX)
	#include "../common_xbox/gsSocketXBox.c"
#elif defined(_WIN32)
	#include "../common_win32/gsSocketWin32.c"
#elif defined(_LINUX)
	//#include "../common_linux/gsSocketLinux.c"
#elif defined(_MACOSX)
	//#include "../common_macosx/gsSocketMacOSX.c"
#elif defined(_NITRO)
	#include "../common_nitro/gsSocketNitro.c"
#elif defined(_PS2)
	#include "../common_ps2/gsSocketPs2.c"
#elif defined(_PS3)
	#include "../common_ps3/gsSocketPs3.c"
	#include <sys/select.h>
#elif defined(_PSP)
	#include "../common_psp/gsSocketPSP.c"
#elif defined(_REVOLUTION)
	#include "../common_revolution/gsSocketRevolution.c"
#else
